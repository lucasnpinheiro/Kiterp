...
class PedidosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'condicao_pagamento_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'numero_cupom' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'nota_fiscal' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'empresa_id' => 1,
            'data_pedido' => '2016-01-04 19:24:39',
            'status' => 1,
            'pessoa_id' => 1,
            ...
            'created' => '2016-01-04 19:24:39',
            'modified' => '2016-01-04 19:24:39'
        ],
    ];
}
