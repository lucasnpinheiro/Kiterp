...
class MenusFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'item_menu' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'grupos' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'root' => 1,
            'item_menu' => 1,
            'grupos' => 'Lorem ipsum dolor sit amet',
            'created' => '2016-01-06 15:58:54',
            'modifield' => '2016-01-06 15:58:54'
        ],
    ];
}
