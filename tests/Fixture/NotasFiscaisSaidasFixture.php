...
/**
 * NotasFiscaisSaidasFixture
 *
 */
class NotasFiscaisSaidasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cancelada' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '0 - Não | 1 - Sim', 'precision' => null, 'autoIncrement' => null],
        ...
        'frete' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '0 - Cif Emitente | 1 - Fob Destinatario', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'cfop_id' => 1,
            'pessoa_id' => 1,
            'data_emissao' => '2016-02-29',
            'data_saida' => '2016-02-29',
            ...
            'created' => '2016-02-29 20:32:09',
            'modified' => '2016-02-29 20:32:09'
        ],
    ];
}
