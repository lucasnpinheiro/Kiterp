...
class ContasReceberFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'valor recebimento' => ['type' => 'float', 'length' => 10, 'precision' => 2, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
    ...
    public $records = [
        [
            ...
            'tradutora_id' => 1,
            'status' => 1,
            'data_recebimento' => '2016-01-04',
            'valor recebimento' => 1,
            'numero_pedido' => 1,
            'nota_fiscal' => 1,
            'serie' => 'Lo',
            'created' => '2016-01-04 19:19:54',
            'modified' => '2016-01-04 19:19:54'
        ],
    ];
}
