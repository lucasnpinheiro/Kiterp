...
/**
 * NotaFiscalEntradaFixture
 *
 */
class NotaFiscalEntradaFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'nota_fiscal_entrada';
    ...
    public $fields = [
        ...
        'data_entrada' => ['type' => 'date', 'length' => null, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        'valor_ipi' => ['type' => 'float', 'length' => 10, 'precision' => 2, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        'valor_frete' => ['type' => 'float', 'length' => 10, 'precision' => 2, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        'valor_seguro' => ['type' => 'float', 'length' => 10, 'precision' => 2, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
    ...
    public $records = [
        [
            ...
            'valor_frete' => 1,
            'valor_seguro' => 1,
            'created' => '2016-01-04 19:22:18',
            'modified' => '2016-01-04 19:22:18'
        ],
    ];
}
