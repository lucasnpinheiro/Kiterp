...
/**
 * NotasFiscaisSaidasItensFixture
 *
 */
class NotasFiscaisSaidasItensFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'notas_fiscais_saida_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'valor_st' => 1,
            'valor_tributo' => 1,
            'created' => '2016-02-29 20:32:17',
            'modified' => '2016-02-29 20:32:17'
        ],
    ];
}
