...
/**
 * NotaFiscalEntradasItensFixture
 *
 */
class NotaFiscalEntradasItensFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nota_fiscal_entrada_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'nota_fiscal_entrada_id' => 1,
            'produto_id' => 1,
            'qtde' => 1,
            'compra' => 1,
            'total' => 1,
            'created' => '2016-01-04 19:24:10',
            'modified' => '2016-01-04 19:24:10'
        ],
    ];
}
