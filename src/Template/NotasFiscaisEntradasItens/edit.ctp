<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $notasFiscaisEntradasIten->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $notasFiscaisEntradasIten->id)]
            )
        ?></li>
...
<div class="notasFiscaisEntradasItens form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Notas Fiscais Entradas Iten') ?></legend>
        <?php
