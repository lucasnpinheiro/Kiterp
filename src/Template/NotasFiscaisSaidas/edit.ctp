<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $notasFiscaisSaida->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $notasFiscaisSaida->id)]
            )
        ?></li>
...
<div class="notasFiscaisSaidas form large-9 medium-8 columns content">
    <?= $this->Form->create($notasFiscaisSaida) ?>
    <fieldset>
        <legend><?= __('Edit Notas Fiscais Saida') ?></legend>
        <?php
            ...
            echo $this->Form->input('transportadora_id', ['options' => $transportadoras, 'empty' => true]);
