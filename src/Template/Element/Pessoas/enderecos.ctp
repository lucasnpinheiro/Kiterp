                    ...
                    <div class="enderecos-multi-field col-xs-12">
                        ...
                        if (count($pessoa->pessoas_enderecos) > 0) {
                            foreach ($pessoa->pessoas_enderecos as $key => $value) {
                                ...
                                echo $this->Form->cep('PessoasEndereco.' . $key . '.cep', ['onChange' => 'cake.util.getCep(this.value, "pessoasendereco-' . $key . '-");', 'required' => true, 'div' => ['class' => 'col-xs-12 col-md-4'], 'value' => $value->cep]);
                            ...
                            echo $this->Form->cep('PessoasEndereco.0.cep', ['onChange' => 'cake.util.getCep(this.value, "pessoasendereco-0-");', 'required' => true, 'div' => ['class' => 'col-xs-12 col-md-4']]);
