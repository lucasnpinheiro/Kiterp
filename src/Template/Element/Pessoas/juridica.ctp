<div class="col-lg-12 div-pessoas-juridica" style="display: none;">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <?php
            if (count($pessoa->pessoas_juridicas) > 0) {
                foreach ($pessoa->pessoas_juridicas as $key => $value) {
                    ...
                    echo $this->Form->cnpj('PessoasJuridica.cnpj', ['required' => true, 'div' => ['class' => 'col-xs-12 col-md-4'], 'value' => $value->cnpj]);
                    ...
                    echo $this->Form->data('PessoasJuridica.data_abertura', ['required' => true, 'div' => ['class' => 'col-xs-12 col-md-4'], 'value' => $value->data_abertura->format('d/m/Y')]);
                ...
                echo $this->Form->cnpj('PessoasJuridica.cnpj', ['required' => true, 'div' => ['class' => 'col-xs-12 col-md-4']]);
                ...
                echo $this->Form->data('PessoasJuridica.data_abertura', ['required' => true, 'div' => ['class' => 'col-xs-12 col-md-4']]);
