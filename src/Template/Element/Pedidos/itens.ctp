<div class="lista-itens-pedidos-clone">
    ...
    <?php echo $this->Form->input('Produto.0.codigo', ['list' => 'codigo_produtos', 'autocomplete' => 'on', 'label' => 'Código', 'class' => 'input-sm busca-produto-input desc-codigo', 'append' => false, 'maxlength' => 32, 'type' => 'text', 'div' => ['class' => 'col-xs-12 col-md-6']]); ?>
