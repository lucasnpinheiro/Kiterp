<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $pedidosFormasPagamento->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $pedidosFormasPagamento->id)]
            )
        ?></li>
...
<div class="pedidosFormasPagamentos form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Pedidos Formas Pagamento') ?></legend>
        <?php
